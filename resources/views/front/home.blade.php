        ...
        <div class="max-w-screen-xl px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <a href="#">
                        <img class="rounded-t-lg w-full h-48 object-cover" src="https://placehold.co/600x400" alt="Pijat Bayi" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Pijat Bayi</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700">
                            Teknik pijat lembut untuk meningkatkan ikatan dan relaksasi.
                        </p>
